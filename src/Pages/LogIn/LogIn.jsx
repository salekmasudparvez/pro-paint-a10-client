        ...
        <div className="hero min-h-screen bg-[url('https://cdn.stocksnap.io/img-thumbs/960w/paint-tube_YQBJGLGPPQ.jpg')] bg-no-repeat bg-center bg-cover">
            <div className="hero-content w-full justify-evenly flex-col lg:flex-row-reverse">
                <div className="text-center lg:w-1/2 lg:text-left">
                    <h1 className="text-5xl font-bold text-[#481E14]">Login now!</h1>
                    <p className="py-6 text-[#481e14ad] ">Enjoy awesome painting and drawing . Don&#39;t miss anything .Log in right now!</p>
                </div>
                <div className="card lg:w-1/2 shrink-0 w-full max-w-sm shadow-2xl bg-white bg-opacity-60">
                    ...
                    <div className="flex justify-center items-center gap-6 my-2">
                        <div className="border border-black p-3 text-blue-500 hover:text-white hover:bg-orange-800 rounded-full"><FaGoogle /></div>
                        <div className="border border-black p-3 hover:text-white hover:bg-orange-800 rounded-full text-gray-500"><FaGithub /></div>
                    </div>

...
const About = () => {
    return (
        <div className="flex justify-between items-center flex-col lg:flex-row rounded-md gap-6 bg-[#FF9178] text-white">

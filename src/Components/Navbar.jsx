...
const Navbar = () => {
    ...
    const links = <>
        ...
        <Navitem to='/bookmarks' name="Bookmarks"></Navitem>
            ...
            <div className="navbar shadow-lg md:px-12 w-full z-50">
                <div className="navbar-start w-[30%] flex justify-start ">
                    <div className=" w-full lg:hidden">
                        ...
                        <div className={`bg-white border lg:hidden transition-opacity duration-300 ease-in-out w-full absolute flex flex-col z-10 rounded-b pb-4 space-y-1 px-3 left-0 right-0 
    ${isOpen ? " translate-y-3 opacity-100" : "opacity-0 -translate-y-[400px]"}`}>
                            {links}
